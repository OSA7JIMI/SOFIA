...
private:
  ...
  bool useSoftMargin_;
  double marginValue_;
  double slackPenalty_;

  bool useSpecificityWeights_;

  bool useRelaxedRules_;
  double relaxedWeight_;

  bool transductiveSetting_;
  bool reportStatsEntity_;
  bool reportStatsRelation_;

  double minForwardChainScore_;
  bool useForwardChainGraph_;
  int forwardChainSize_;
  int maxChainSize_;
...
public:
  ...
  bool getUseFrequencyBias() {return useFrequencyBias_;}

  bool getUseSoftMargin() {return useSoftMargin_;}
  double getMarginValue() {return marginValue_;}
  double getSlackPenalty() {return slackPenalty_;}

  bool getUseSpecificityWeights() {return useSpecificityWeights_;}
  bool getUseRelaxedRules() {return useRelaxedRules_;}
  bool getRelaxedWeight() {return relaxedWeight_;}
  bool getTransductiveSetting() {return transductiveSetting_;}

  void addReportStatsEntity(bool reportStatsAllRemoval) {reportStatsEntity_ = reportStatsAllRemoval;}
  bool getReportStatsEntity() {return reportStatsEntity_;}

  void addReportStatsRelation(bool reportStatsRelation) {reportStatsRelation_ = reportStatsRelation;}
  bool getReportStatsRelation() {return reportStatsRelation_;}

  double getMinForwardChainScore() {return minForwardChainScore_;}
  bool getUseForwardChainGraph() {return useForwardChainGraph_;}
  int getForwardChainSize() {return forwardChainSize_;}
  int getMaxChainSize() {return maxChainSize_;}
