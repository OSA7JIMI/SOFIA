...
private:
  ...
  vector<vector<double> > rulesspecificity_;
  ...
  vector<vector<int> > rankingsAggressiveRelationRaw_;
  vector<vector<int> > rankingsAggressiveRelationFiltered_;
  vector<vector<int> > rankingsMidPointRelationRaw_;
  vector<vector<int> > rankingsMidPointRelationFiltered_;
  vector<vector<int> > rankingsRandomBreakRelationRaw_;
  vector<vector<int> > rankingsRandomBreakRelationFiltered_;
  vector<vector<int> > rankingsRelationRaw_;
  vector<vector<int> > rankingsRelationFiltered_;
...
public:
  ...
  void run(string scoresFileName, string rulesFileName, string inputRulesFileName, string forwardChainFileName);
  ...
  void getRelationsOfInterest(int entity1, int entity2, vector<bool>& useRelation, bool useAllData);
  void getRelationScores(int entity1, int entity2, 
                                vector<double>& relationScores, bool useBFS);
  ...
  void computeStatistics(string fname, vector<vector<int> >& rankingsAggressive, vector<vector<int> >& rankingsMidPoint, vector<vector<int> >& rankingsRandomBreak, vector<vector<int> >& rankings, bool isFiltered);
  void computeStatisticsForRelations(string fname, vector<vector<int> >& rankingsAggressive, vector<vector<int> >& rankingsMidPoint, vector<vector<int> >& rankingsRandomBreak, vector<vector<int> >& rankings, bool isFiltered);
  ...
  void getRelationScores(pair<int,int>& pair, vector<double>& scores, bool useBFS);
  void writeRelationScoresToFile(int modifiedRelationId, string fname);

  void writeForwardChainGraph(string forwardChainFileName, string inputRulesFileName);
