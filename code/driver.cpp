...
main (int argc, char* argv[])
{
  ...
  if (relationId < 0) {
    remove(forwardChainFileName.c_str());
    solver.writeForwardChainGraph(forwardChainFileName, inputRulesFileName);
  }
    ...
    solver.run(scoresFileName, rulesFileName, inputRulesFileName, forwardChainFileName);
  }
